...
ALTER TABLE USER MODIFY CHINAME CHAR(20) CHARACTER SET UTF8;
ALTER TABLE USER MODIFY DEPARTMENT CHAR(100) CHARACTER SET UTF8;
...
ALTER TABLE ADMINISTRATOR MODIFY CHINAME CHAR(20) CHARACTER SET UTF8;
...
ALTER TABLE LOCATION MODIFY LOCATIONNAME CHAR(100) CHARACTER SET UTF8;
